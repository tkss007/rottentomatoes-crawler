...
def getinfo(url):
    ...
    result = result_name + result_tom_s + result_aud_s + result_info
    if result_cast != []:
...
with open("test.csv","w") as csvfile: 
	writer = csv.writer(csvfile)
	writer.writerow(['Title','Rotten_Tomatoes_Score','Audience_Score','Rating','Genre','Dircted_By','Written_BY','In_Theaters','On_Sisc/Streaming','Box_Office','Runtime','Studio','Actor_1','Actor_2','Actor_3','Actor_4','Actor_5','Actor_6','Review_1','Review_2','Review_3','Review_4','Review_5','Review_6','Review_7','Review_8','Review_9','Review_10'])
