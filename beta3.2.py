...
def getinfo(url):
    ...
    with open(result_category[0] + ".csv","a") as csvfile:
...
"""
url_top_100 = raw_input("Enter the url of the website of the top 100 and press the enter buttom. \nFor example: If you want the top 100 of action&adventure_movies, just copy or enter the url like this: https://www.rottentomatoes.com/top/bestofrt/top_100_action__adventure_movies/ then press enter.\nEnter or paste the url here:")
...
with open(result_category[0] + ".csv","w") as csvfile:
    writer = csv.writer(csvfile)
